...
**Lab 练习**：
1. 用上面的代码画出 $$\boldsymbol{p}_m\cdot\boldsymbol{p}_n$$ 随 $$\vertm-n\vert$$ 的曲线（$$d=128$$，base=10000），观察衰减震荡——预期在 $$\vertm-n\vert\approx 50$$ 时内积降至峰值的 10% 以下，$$\vertm-n\vert\approx 200$$ 时趋近于零；再换 base=100、base=1000000 对比衰减速度，直观感受"底数决定频率谱覆盖"；
