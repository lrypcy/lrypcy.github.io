...
$$fl(a\times b + c) = (a\times b + c)(1+\epsilon_1), \quad \vert\epsilon_1\vert \le u$$

分离式则有两层误差叠加：

$$fl\big(fl(a\times b) + c\big) = \big(ab(1+\epsilon_2) + c\big)(1+\epsilon_3), \quad \vert\epsilon_2\vert, \vert\epsilon_3\vert \le u$$
