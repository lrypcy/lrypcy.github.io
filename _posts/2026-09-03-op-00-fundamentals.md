...
> **算子开发与优化系列 · 第 00 篇 / 共 13 篇**
>
> 本系列面向有算子使用经验（PyTorch/CUDA 基础）、想进阶资深工程师、下一步目标是算子专家的读者。全系列 13 篇，从"算子的本质"讲起，经硬件原理、语言选型、性能分析方法论、优化技术体系，到三大经典案例实战，再深入到超越函数硬件实现原理与跨硬件 Profiling 工具链，最后上升到算子库设计、性能模型与 AI 辅助开发。
>
...
> **一句话总结本节**：Roofline 告诉你"瓶颈在哪一侧"，而"把点往右推"就是全部优化工作的本质。05 篇的 GEMM 金字塔就是这条思路的完整展开。
...
| 03 | 性能分析方法论 | 15 分钟定位算子瓶颈的实操流程 |
| 04 | 优化技术体系 | tiling / 向量化 / 双缓冲 / 布局优化工具箱 |
| 05-07 | 三大案例 | GEMM、FlashAttention、LayerNorm 完整实战 |
| 08-10 | 进阶 | 国产 NPU、编译器集成、专家之路 |
